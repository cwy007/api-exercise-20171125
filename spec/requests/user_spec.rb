...
RSpec.describe "API_V1::Users", :type => :request do
  ...
  example 'GET /me' do
    ...
    @user.reload        # NOTE: difference from in-memory and the database
  ...
  it "PATCH /me" do
    # 上传档案，放一个图档在 spec/fixtures 目录下
    file = fixture_file_upload("#{Rails.root}/spec/fixtures/test.png", "image/png")
